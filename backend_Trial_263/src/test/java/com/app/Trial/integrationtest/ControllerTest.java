...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM trial_801.FundingRound");
    jdbcTemplate.execute("DELETE FROM trial_801.Stage");
    jdbcTemplate.execute("DELETE FROM trial_801.Document");
    jdbcTemplate.execute("DELETE FROM trial_801.Investor");
    jdbcTemplate.execute("DELETE FROM trial_801.Founder");
    jdbcTemplate.execute("DELETE FROM trial_801.Startup");
     jdbcTemplate.execute("DELETE FROM trial_801.StartupFounders");
     jdbcTemplate.execute("DELETE FROM trial_801.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM trial_801.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM trial_801.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM trial_801.FundingRoundInvestors");
